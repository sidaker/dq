...
def process_pnrdetails(document):
    ...
    try:
        ...
        #for el_pn in document.getElementsByTagName('pnrDetails'):

        #    pnrdetails['pnrdetails_accompaniedbyinfant'] = get_tag_value(el_pn, 'accompaniedByInfant')

        #    for el_pn_pd in el_pn.getElementsByTagName('pnrData'):

        #        for el_pn_pd_pr in el_pn_pd.getElementsByTagName('pnrDetail'):

        #            pnrdetails['pnrdetails_accompaniedbyinfant'] = get_tag_value(el_pn_pd_pr, 'accompaniedByInfant')
        #            # wrong
        #            pnrdetails['pnrdetails_unaccompaniedminor'] = get_tag_value(el_pn_pd_pr, 'accompaniedByInfant')
        #            pnrdetails['pnrdetails_bookingdate'] = get_tag_value(el_pn_pd_pr, 'bookingDate')
        #            pnrdetails['pnrdetails_creationdate'] = get_tag_value(el_pn_pd_pr, 'creationDate')
        #            pnrdetails['pnrdetails_masterpnrlocator'] = get_tag_value(el_pn_pd_pr, 'masterPNRLocator')
        #            pnrdetails['pnrdetails_modifieddate'] = get_tag_value(el_pn_pd_pr, 'modifiedDate')
        #            pnrdetails['pnrdetails_pnrlocator'] = get_tag_value(el_pn_pd_pr, 'pnrLocator')
        #            pnrdetails['pnrdetails_retrieveddate'] = get_tag_value(el_pn_pd_pr, 'retrievedDate')
        #            pnrdetails['pnrdetails_splitpnr'] = get_tag_value(el_pn_pd_pr, 'splitPNR')
        #            pnrdetails['pnrdetails_travelagent'] = get_tag_value(el_pn_pd_pr, 'travelAgent')
...
def main():
    try:
        downloaded_file = "/Users/sbommireddy/Downloads/Edited XMLs.zip"
        key_name='Users/sbommireddy/Documents/csvs'
        file_name='testfile'
        ...
        for xml_file in xml_file_list:
            ...
            if document.getElementsByTagName('APIData'):
                ...
                s3_file_name = key_name + '/' + xml_file.split('/')[-1] + '/api.csv'
