...
#df3['DateofBirth'].fillna('01/01/1900')
#print("--------")
print(df3['DateofBirth'].tail())
print("--------")
print(df3['DateofBirth'].tail().notna())
#df3.to_parquet("/Users/sbommireddy/Documents/python/assignments/dq/dataformats/zz.snappy.parquet", engine='pyarrow', compression='snappy')
