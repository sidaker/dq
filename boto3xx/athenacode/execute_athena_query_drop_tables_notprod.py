...
with open(filepath) as fp:
   ...
   while line:
       ...
       response = client.start_query_execution(QueryString=query1,
                                               ...
                                               ResultConfiguration={'OutputLocation': 's3://s3-dq-athena-log-prod/working/default-output/'})


response = client.start_query_execution(QueryString=" SHOW TABLES IN snsgb_prod 'input_file_itemdetails_*' ",
                                        QueryExecutionContext={'Database': ath_db},
                                        ResultConfiguration={'OutputLocation': 's3://s3-dq-athena-log-prod/working/default-output/'})
