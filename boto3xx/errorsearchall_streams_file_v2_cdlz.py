...
python errorsearchall_streams_file_v2_cdlz.py "/aws/lambda/drt-prod-json-lambda"

python errorsearchall_streams_file_v2_cdlz.py \
"/aws/lambda/cdlz-prod-lambda" \
--start= \
--end= \
--stream_prefix="2020/09/19/"
