...
def get_partitions(database, table, retention, arg_std, arg_ppt):
    ...
    myexp = "std_date_local = arg_std and  partition_process_timestamp = arg_ppt "
    #print(myexp)
    try:
        kwargs = {
...
if __name__=='__main__':
    ...
    table_name='internal_storage_by_std_date_local_recent'
    ...
    mycsvfile = '/Users/sbommireddy/Desktop/BAU_DOCS/partitions_for_dropping_from_local_recent.csv'
    from csv import reader
    # read csv file as a list of lists
    with open(mycsvfile, 'r') as read_obj:
        #
