...
Usage: errorsearchall_streams_file_v2.py <LOG_GROUP_NAME> [--start=<START>] [--end=<END>] [--stream_prefix=<STREAM_PREFIX>]
       ...
       python internalreport_errorsearchall_streams_file_v3.py "/aws/lambda/internal-reporting-prod-lambda-athena" --stream_prefix="2021/04/07/"
...
def get_error_log_events(env,log_group,stream_list,limit=50):
    ...
    kwargs = {
        ...
        'filterPattern': "transform_api_record_level_scored_document_details?",
        'limit': limit,
                }
    kwargs['filterPattern'] = "?transform_api_record_level_scored_document_details"

    while True:
        # BUG: works only for the first filter pattern.
        # Works fine when used with out **kwargs.
        # internal_storage_document_details
